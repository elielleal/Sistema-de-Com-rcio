        ...
        private void btnSalvar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtNome.Text == string.Empty)
                {
                    ...
                    errorIcone.SetError(txtNome, "Insira o nome da Cliente");
                ...
                else
                {
                    if (this.eNovo)
                    {
                        resp = NCliente.Inserir(this.txtNome.Text.Trim().ToUpper(), 
                            this.txtSobrenome.Text, this.cbSexo.Text, this.dtData.Value, this.cbTipoDoc.Text, this.txtNumeroDoc.Text, this.txtEndereco.Text, this.txtTelefone.Text, this.txtEmail.Text);
                    }
                    else
                    {
                        resp = NCliente.Editar(Convert.ToInt32(this.txtId.Text),
                           this.txtNome.Text.Trim().ToUpper(), this.txtSobrenome.Text, this.cbSexo.Text, this.dtData.Value, this.cbTipoDoc.Text, this.txtNumeroDoc.Text, this.txtEndereco.Text, this.txtTelefone.Text, this.txtEmail.Text);
                    }
                    if (resp.Equals("OK"))
                    {
                        if (this.eNovo)
