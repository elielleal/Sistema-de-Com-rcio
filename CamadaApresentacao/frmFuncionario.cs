...
namespace CamadaApresentacao
{
    public partial class frmFuncionario : Form
    {
        ...
        private void btnSalvar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    if (this.eNovo)
                    {
                        resp = NFuncionario.Inserir(this.txtNome.Text.Trim().ToUpper(), this.txtSobrenome.Text, this.cbSexo.Text, this.dtData.Value, this.txtNumeroDoc.Text, this.txtEndereco.Text, this.txtTelefone.Text, this.txtEmail.Text, this.cbAcesso.Text, this.txtUsuario.Text, txtSenha.Text);
                    }
                    else
                    {
                        resp = NFuncionario.Editar(Convert.ToInt32(this.txtId.Text),
                           this.txtNome.Text.Trim().ToUpper(), this.txtSobrenome.Text, this.cbSexo.Text, this.dtData.Value, this.txtNumeroDoc.Text, this.txtEndereco.Text, this.txtTelefone.Text, this.txtEmail.Text, this.cbAcesso.Text, this.txtUsuario.Text, txtSenha.Text);
                    }
                    if (resp.Equals("OK"))
                    {
                        if (this.eNovo)
        ...
        private void dataLista_DoubleClick(object sender, EventArgs e)
        {
            ...
            this.dtData.Value = Convert.ToDateTime(this.dataLista.CurrentRow.Cells["data_nascimento"].Value);
