...
namespace CamadaApresentacao
{
    public partial class frmFornecedor : Form
    {
        ...
        {
            InitializeComponent();
            this.ttMensagem.SetToolTip(this.txtEmpresa, "Insira o nome do Empresa");
        }
        ...
        private void btnSalvar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    if (this.eNovo)
                    {
                        resp = NFornecedor.Inserir(this.txtEmpresa.Text.Trim().ToUpper(), this.cbSetorComercial.Text, this.cbTipoDoc.Text, this.txtNumDoc.Text.Trim().ToUpper(), this.txtEndereco.Text, txtTelefone.Text, txtEmail.Text, txtUrl.Text);
                    }
                    else
                    {
                        resp = NFornecedor.Editar(Convert.ToInt32(this.txtId.Text),
                           this.txtEmpresa.Text.Trim().ToUpper(), this.cbSetorComercial.Text, this.cbTipoDoc.Text, this.txtNumDoc.Text.Trim().ToUpper(), this.txtEndereco.Text, txtTelefone.Text, txtEmail.Text, txtUrl.Text);
                    }
                    if (resp.Equals("OK"))
                    {
                        if (this.eNovo)
